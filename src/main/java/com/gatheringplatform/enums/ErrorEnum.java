...
public enum ErrorEnum {
    ...
    VALIDATION_FAIL("VALIDATION_FAIL", "유효성 검사 실패하였습니다.", HttpStatus.BAD_REQUEST),

    INVALID_ID("LOGIN_01", "유효하지 않은 아이디입니다", HttpStatus.BAD_REQUEST),
    INVALID_PW("LOGIN_02", "비밀번호가 올바르지 않습니다.", HttpStatus.BAD_REQUEST),

    UNAUTHORIZED("UNAUTHORIZED", "요청 권한이 없습니다.", HttpStatus.FORBIDDEN),
    ...
    ACCESSTOKEN_NULL("ACTOKEN_05", "요청하신 AccessToken 이 비어있습니다. 헤더를 확인하세요", HttpStatus.UNAUTHORIZED),
    ...
    REFRESHTOKEN_NULL("RETOKEN_05", "요청하신 RefreshToken 이 비어있습니다. 헤더를 확인하세요", HttpStatus.UNAUTHORIZED),
    ...
    //page
    NON_EXISTED_PAGE("PAGE_01", "존재하지 않는 페이지입니다.", HttpStatus.NOT_FOUND),
    INVALID_CATEGORY("PAGE_02", "유효하지 않은 카테고리입니다.", HttpStatus.NOT_FOUND),
    DELETED_PAGE("PAGE_03", "삭제되었거나 존재하지 않는 페이지입니다.", HttpStatus.NOT_FOUND),
